  ...
  return (
    <header className="bg-white border-b border-slate-200 sticky top-0 z-40 shadow-subtle pt-safe-top">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        {/* Navigation Quick Links (Hidden on small mobile) */}
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3 pl-3 border-l border-slate-200">
            <Link to="/farmer/profile" className="flex items-center gap-2 text-left group hover:bg-slate-50 p-1.5 rounded-lg transition cursor-pointer">
